<template>
  <div :class="cssClass">
    ...
    <div class="data-card-inner__image">
      <inline-svg src="/images/data-cards/city-countryside-ratio.svg" />
    </div>
...
<script>
export default {
  name: 'DataCardInnerDemographicsCityCountrysideRatio',
  props: {
    animationDisabled: {
      type: Boolean,
      default () {
  ...
  data () {
    return {
      ...
      apiDataProperty: 'share_of_country_population'
    }
  },
  computed: {
    value () {
    ...
    cssClass () {
      let cssClass = 'data-card-inner data-card-inner--city-countryside data-card-inner--demographics'
...
<style lang="scss">
.data-card-inner--city-countryside {
  position: relative;
